...
from const import TOP_N_DEFAULT, COLOR_INBOUND, COLOR_OUTBOUND
...
def get_figure(df: pd.DataFrame, selected_corridors: list[str] | None = None) -> go.Figure:
    ...
    fig = make_subplots(
        ...
        subplot_titles=["AM Peak (7–9h)", "PM Peak (16–18h)"],
        shared_yaxes=True,
